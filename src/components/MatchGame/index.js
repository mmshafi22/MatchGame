...
class MatchGame extends Component {
  ...
  render() {
    ...
    const categoryList = imagesList.filter(each => each.category === isActive)
    return (
      <>
              ...
              <ul className="tab-lists">
                {tabsList.map(eachTab => (
                  <TabItem
                    ...
                    isSelected={isActive === eachTab.tabId}
                  />
                ))}
              </ul>
              <ul className="thumbnail-container">
                {categoryList.map(eachThumb => (
                  <ThumbnailItem
                    details={eachThumb}
                    key={eachThumb.id}
